...
- Type: Optional
- Description: Create `S3_BUCKET` when LobeHub starts if it does not exist yet. The Docker Compose deployment enables it for the bundled RustFS. Leave it disabled when buckets are provisioned separately.
- Default: `-` (disabled)
- Example: `1`
